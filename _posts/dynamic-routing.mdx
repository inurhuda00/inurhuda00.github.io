...
also jump to the [list of services](/posts/dynamic-routing#list-of-services) directly.

## Table of Contents

-   [Backend Basics](/posts/dynamic-routing#backend-basics)
-   [Do You Even Need a Database?](/posts/dynamic-routing#do-you-even-need-a-database)
-   [Low Code Solutions](/posts/dynamic-routing#low-code-solutions)
-   [Terms To Understand](/posts/dynamic-routing#terms-to-understand)
    -   [SQL / NoSQL](/posts/dynamic-routing#sql--nosql)
    -   [GraphQL / REST](/posts/dynamic-routing#graphql--rest)
    -   [Authentication / Authorization](/posts/dynamic-routing#authentication--authorization)
    -   [Hosted / Self-Hosted](/posts/dynamic-routing#hosted--self-hosted)
    -   [Serverless](/posts/dynamic-routing#serverless)
    -   [Data Modeling](/posts/dynamic-routing#data-modeling)
-   [Levels of Abstraction](/posts/dynamic-routing#levels-of-abstraction)
-   [List of Services](/posts/dynamic-routing#list-of-services)
    -   [Backend (as a Service)](/posts/dynamic-routing#backend-as-a-service)
        -   [Firebase](/posts/dynamic-routing#firebase)
        -   [Hasura](/posts/dynamic-routing#hasura)
    -   [Build Your Own Backend](/posts/dynamic-routing#build-your-own-backend)
        -   [Prisma](/posts/dynamic-routing#prisma)
    -   [Others](/posts/dynamic-routing#others)
-   [Should You Use a CMS?](/posts/dynamic-routing#should-you-use-a-cms)
-   [Starting From Scratch](/posts/dynamic-routing#starting-from-scratch)
-   [Conclusion / Resources](/posts/dynamic-routing#conclusion--resources)
...
If you want complete control, you might consider [building your own](/posts/dynamic-routing#build-your-own-backend).
